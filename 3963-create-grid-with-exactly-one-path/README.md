<h2><a href="https://leetcode.com/problems/create-grid-with-exactly-one-path/?envType=problem-list-v2&envId=vg3jzaz7">4342. Create Grid With Exactly One Path</a></h2><h3>Easy</h3><hr><p>You are given two integers <code>m</code> and <code>n</code>, representing the number of rows and columns of a grid.</p>
